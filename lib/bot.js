...
Bot.prototype.initialize = function () {
        ...
        this.connection.addListener ('topic', proxy (this.onTopic, this));
...
Bot.prototype.onPart = function (channel, nick, reason, message) {
        ...
        this.forward (function (client) {
                client.sendMessage (this.getIdentifier () + ':' + this.breakPing (nick) + ' has left (' + reason + ')');
        });
};
 ...
 * @param message The parsed message.
 */
Bot.prototype.onTopic = function (channel, topic, nickname, message) {
        "use strict";

        this.debug ('Received topic change on ' + this.getIdentifier ());
        this.forward (function (client) {
                client.sendMessage (this.getIdentifier() + ':' + this.breakPing (nickname) + ' has changed the topic to: ' + topic);
        });
};
